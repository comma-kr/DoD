...
insert into region_commute (district_name, commute_area, min_minutes, max_minutes, transfer_count, verdict, description) values
  ...
  ('송파구', 'mapo', 40, 60, 1, '불편', '환승 포함 한 시간 내외'),
