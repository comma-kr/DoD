...
const SGG_NAMES = {
  ...
  // 경기 분구 포함 44
  '41111': '수원 장안구', '41113': '수원 권선구',
  '41115': '수원 팔달구', '41117': '수원 영통구',
  '41131': '성남 수정구', '41133': '성남 중원구', '41135': '성남 분당구',
  '41150': '의정부시',
  '41171': '안양 만안구', '41173': '안양 동안구',
  // 부천: 통합(41190)은 K-Apt에 데이터 없음, 옛 분구 코드만 작동
  '41190': '부천시(통합 — K-Apt 데이터 없음)',
  '41192': '부천 원미구(옛)', '41194': '부천 소사구(옛)', '41196': '부천 오정구(옛)',
  ...
  '41570': '김포시',
  // 화성: K-Apt에 데이터 없음. RTMS만 41591/41595/41597로 분리.
  // seed-region-rtms.mjs를 사용해 RTMS 우회 시드.
  '41590': '화성시(K-Apt 데이터 없음 — RTMS 우회 필요)',
  '41591': '화성시 서부(남양)', '41595': '화성시 반월', '41597': '화성시 동탄',
  '41610': '광주시',
