...
- **서비스명**: 입지990
- **한 줄 설명**: 내가 아는 단지는 공짜로 제대로, 옆 단지와 나란히 보기는 990원
- **비즈니스 모델**: 박리다매 소액 단건 결제 (**990 / 1,990 / 2,990원**)
- **핵심 원칙 (절대 훼손 금지)**:
  1. **무료 = 완결된 단일 단지 심층 분석** (계정당 1회, 진짜 리포트)
  2. **990원 = 옆 단지와 나란히 보기** — 비교가 핵심 유료 전환점
  3. **업셀 톤은 부동산 무게감 배제** — "고민 정리", "커피 한 입 값"
  4. **진입장벽 제로** — SMS 인증만, 소셜 로그인 강요 금지
  5. **데이터 환각 금지** — 숫자는 DB 원본, AI는 해석만
- **타겟**: 예비 매수자, 갈아타기 검토자, 관심 단지 지켜보는 사람, 학부모
